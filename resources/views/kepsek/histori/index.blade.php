...
<div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 mb-6">
    <form action="{{ route('kepsek.histori.index') }}" method="GET" class="flex flex-col md:flex-row md:items-end gap-4">
        ...
        <div class="w-full md:flex-1 min-w-[150px]">
            <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-2">Guru</label>
            <select name="guru_id" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 text-sm py-2 px-3 bg-gray-50 hover:bg-white transition-colors">
        ...
        <div class="w-full md:flex-1 min-w-[150px]">
            <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-2">Mata Pelajaran</label>
        ...
        <div class="flex space-x-2">
            ...
            <a href="{{ route('kepsek.histori.index') }}" class="px-4 py-2 bg-gray-100 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-200 transition-colors">
                Reset
            </a>
        </div>
    </form>
            ...
            <tbody class="divide-y divide-gray-100">
                @forelse($sesis as $sesi)
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-4 py-3 text-gray-600 whitespace-nowrap">{{ $sesi->guru->nama_guru }}</td>
                        ...
                        <td class="px-4 py-3 text-center">
                            <a href="{{ route('kepsek.histori.show', $sesi->id) }}" class="inline-flex items-center gap-1 px-3 py-1.5 bg-indigo-50 text-indigo-700 hover:bg-indigo-100 rounded-lg text-xs font-bold transition-colors">
                                DETAIL
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="10" class="px-4 py-8 text-center text-gray-500">
                            <div class="flex flex-col items-center">
                                ...
                                <span class="text-xs mt-1">Daftar seluruh kegiatan pembelajaran akan muncul di sini.</span>
                            </div>
                        </td>
                    </tr>
                @endforelse

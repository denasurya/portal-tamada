...
<body>
    ...
    <div class="stats-box">
        <table class="stats-table">
            <tr>
                <td width="33%"><strong>Total Siswa Target:</strong> {{ $stats['total_expected'] }}</td>
                <td width="33%"><strong>Hadir Valid:</strong> {{ $stats['hadir_valid'] }}</td>
                <td width="33%"><strong>Tidak Hadir:</strong> {{ $stats['tidak_hadir'] }}</td>
            </tr>
            <tr>
                <td><strong>Sakit:</strong> {{ $stats['sakit'] }}</td>
                <td><strong>Izin:</strong> {{ $stats['izin'] }}</td>
                <td><strong>Tidak Konfirmasi:</strong> {{ $stats['tidak_konfirmasi'] }}</td>
            </tr>
            <tr>
                <td colspan="3"><strong>Persentase Kehadiran:</strong> {{ $stats['persentase'] }}%</td>
            </tr>
        </table>
    </div>

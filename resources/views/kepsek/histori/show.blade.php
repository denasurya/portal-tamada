...
<div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
    <div>
        <a href="{{ route('kepsek.histori.index') }}" class="inline-flex items-center text-sm font-medium text-gray-500 hover:text-indigo-600 transition-colors mb-2">
    ...
    <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
        <!-- DOWNLOAD EXCEL -->
        <a href="{{ route('kepsek.histori.download.excel', $sesi->id) }}" hx-boost="false" class="inline-flex items-center justify-center px-4 py-2.5 border border-green-600 shadow-sm text-sm font-medium rounded-lg text-green-700 bg-white hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors">
        ...
        <!-- DOWNLOAD PDF -->
        <a href="{{ route('kepsek.histori.download.pdf', $sesi->id) }}" hx-boost="false" class="inline-flex items-center justify-center px-4 py-2.5 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4">
                ...
                <div>
                    ...
                    <span class="block text-sm text-gray-800 font-medium">{{ $sesi->guru->nama_guru }}</span>
                </div>
                <div class="sm:col-span-2 border-t border-gray-100 pt-4 mt-2"></div>
    ...
    <div class="lg:col-span-2">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mb-6">
            ...
            <div class="p-4 bg-gray-50 border-b border-gray-100">
                <form action="{{ route('kepsek.histori.show', $sesi->id) }}" method="GET" class="flex flex-col sm:flex-row gap-4 items-end">
                    ...
                    @if(request()->hasAny(['filter_rombel_id', 'filter_status', 'search_nama']))
                        <a href="{{ route('kepsek.histori.show', $sesi->id) }}" class="px-4 py-2 bg-gray-200 text-gray-700 text-sm font-medium rounded-md hover:bg-gray-300 transition-colors flex items-center justify-center">Reset</a>
                    @endif
                </form>
            </div>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-center">
                                    ...
                                    @elseif($absensi->status == 'tidak_konfirmasi')
                                        <span class="px-2 py-1 bg-gray-50 text-gray-700 border border-gray-200 rounded text-xs font-semibold whitespace-nowrap">Tidak Konfirmasi</span>
                                    @elseif($absensi->status == 'tidak_hadir')
                                        <span class="px-2 py-1 bg-red-50 text-red-700 border border-red-200 rounded text-xs font-semibold whitespace-nowrap">Tidak Hadir</span>
                                    @else
